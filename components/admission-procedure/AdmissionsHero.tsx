...
export default function AdmissionsHero() {
  ...
  return (
    <section className="min-h-screen w-full flex items-center bg-white pt-8 text-justify">
      <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-center gap-8 md:gap-12 px-4 sm:px-6 md:px-8">
        {/* LEFT SIDE - CONTENT */}
